//#region node_modules/.nitro/vite/services/ssr/assets/company-CYMT_m4Z.js
/**
...
var company = {
	...
	registeredOffice: {
		...
		lines: [
			"409/2 DDA Building II, District Center",
			"Janak Palace, Janakpuri",
	...
	developer: { name: "Appnity Softwares Private Limited" }
};
...
var verifiedFacts = [
	{
		...
		note: "Incorporated 16 Feb 2010"
	},
	{
		value: `${company.listedProductCount}+`,
		label: "Products listed",
		note: "Public TradeIndia catalogue"
	},
	{
		value: "3",
		label: "Business roles",
		note: "Manufacturer · Supplier · Trading"
	},
	{
		value: "7",
		label: "Working days",
...
*/
var editable = {
	projectsNote: "Project references and site photographs will be published here once supplied and approved by Micro Technocam Equipments Pvt. Ltd.",
	certificationsNote: "Certification and quality documentation can be listed in this section when the company provides the relevant certificates."
};
//#endregion
export { editable as n, verifiedFacts as r, company as t };
