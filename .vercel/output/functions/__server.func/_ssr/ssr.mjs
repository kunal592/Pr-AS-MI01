...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-COUpEsCr.mjs");
...
var manifest = { "734f4d746ddb2b1e931f1004330a70be1fed7cc99da2f1b12614af0e6d7560b4": {
	...
	importer: () => import("./rfq.functions-D50jdgRH.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DmREofo0.mjs"),
		import("./start-4jTVhH7y.mjs"),
